...
<div class="row">
    <div class="col-md-8 offset-md-2">
        <h1 class="display-4 mb-4">Edit Portfolio</h1>
            ...
            <div class="card-body">
                <form action="{{ route('admin.portfolio.update', $portfolio->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('programming_language') is-invalid @enderror" 
                                   id="programming_language" name="programming_language" value="{{ old('programming_language', $portfolio->programming_language) }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('database') is-invalid @enderror" 
                                   id="database" name="database" value="{{ old('database', $portfolio->database) }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('frontend') is-invalid @enderror" 
                                   id="frontend" name="frontend" value="{{ old('frontend', $portfolio->frontend) }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('backend') is-invalid @enderror" 
                                   id="backend" name="backend" value="{{ old('backend', $portfolio->backend) }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('additional_features') is-invalid @enderror" 
                                   id="additional_features" name="additional_features" value="{{ old('additional_features', $portfolio->additional_features) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="url" class="form-control @error('github_url') is-invalid @enderror" 
                                   id="github_url" name="github_url" value="{{ old('github_url', $portfolio->github_url) }}" 
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="url" class="form-control @error('demo_url') is-invalid @enderror" 
                                   id="demo_url" name="demo_url" value="{{ old('demo_url', $portfolio->demo_url) }}" 
                    ...
                    <div class="d-flex justify-content-between">
                        <a href="{{ route('admin.portfolio') }}" class="btn" style="background-color: #ff6b6b; color: #112240; border: none; padding: 8px 16px;">
                            <i class="fas fa-arrow-left me-2"></i>Kembali
                        </a>
                        <button type="submit" class="btn" style="background-color: #ff6b6b; color: #112240; border: none; padding: 8px 16px;">
